t=('Murilo','Jessica','Dandan','Douglas')#imutav
...
print('Contando: ',t.count('Dandan'))#quant
print('Indice: ',t.index('Dandan'))#indice
print('indice: ',t.index('Douglas',1))#a partir
...
print(' ========== LISTAS ==========')
print('Lista: ',lista)
lista.append('Murilo')#adicionando
lista.append('Jessica')
lista.append('Dandan')
lista.append('Douglas')
print('ADICIONADOS à lista: ',lista)

lista[2]='Sobrinho'#substituindo
print('Substituindo: ',lista)

lista.count('Douglas')#quantos tem na lista
...
pessoa.append('Murilo')#adicionando
print(dados)
print(pessoa)
pessoa.append(34)
print(dados)
...
dados['Nome']='José Murilo' #Alterar valor
print(dados)
print()
